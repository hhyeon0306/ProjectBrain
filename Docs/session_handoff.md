...
최신 확정: Codex 재실행 후 현재 대화의 내장 HTTP MCP 도구 38개 노출, scene-list-opened 및 unity-tool-list 성공. 씬 RootCount=2/IsDirty=false. 연결 복구 완료이며 아래 재로딩 대기·stdio 장애는 과거 기록이다. 다음 제품 작업은 A1-R/F2 보완.
